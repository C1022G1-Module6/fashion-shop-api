...
public class NewsRestController_createNews {
    ...
    public void createNews_img_15() throws Exception {
        ...
        NewsDTO newsDTO = new NewsDTO();
        newsDTO.setTitle("ANNE HATHAWAY HOÁ “THIÊN NGA ĐEN” ICONS");
    ...
    public void createNews_content_18() throws Exception {
        ...
        newsDTO.setImg("https://www.elle.vn/wp-content/uploads/2023/04/12/524301/01-UNIQLO-Ket-Hop-Cung-JW-ANDERSON-Ra-Mat-BST-Dac-Biet-tu-30_03-in-dam-dau-an-phong-cach-co-dien-dac-trung-cua-cac-Truong-Dai-Hoc-Anh-Quoc.--445x250.png");
        newsDTO.setContent("Hình ảnh của chiến dịch lần này   của các nhiếp ảnh gia Mert và Marcus. Bộ sưu tập sẽ được ra mắt trên trang Versace.com và tại cửa hàng vào ngày 3 tháng 4. ");
        this.mockMvc
                .perform(MockMvcRequestBuilders
                        .post("http://localhost:8080/api-news/createNews")
                        .content(this.objectMapper.writeValueAsString(newsDTO))
